...
public class Sales extends HashMap<String, List<Sale>> {
    ...
    public void addSale(String productType, Double value) {
        Sale sale = new Sale(productType, value);
        log.info(sale.toString());
        this.merge(productType.toUpperCase(), new ArrayList<>(Collections.singletonList(sale)), (v1, v2) -> {v1.addAll(v2); return v1;} );
    }
}
